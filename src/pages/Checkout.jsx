  ...
  return (
    <div className="flex flex-col h-full animate-fade-in bg-color pb-6" style={{ minHeight: '100vh', paddingBottom: '32px' }}>
      ...
      <div className="page-wrapper">
        <div className="responsive-row" style={{ marginTop: '16px' }}>
          ...
          <div style={{ flex: '1' }}>
            <div style={{ backgroundColor: 'white', padding: '24px', borderRadius: '16px', boxShadow: 'var(--surface-shadow)' }}>
              <h3 className="font-bold text-lg text-dark" style={{ marginBottom: '16px' }}>Order Summary</h3>
